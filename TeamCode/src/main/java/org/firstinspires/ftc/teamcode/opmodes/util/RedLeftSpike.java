...
public class RedLeftSpike extends OpMode {
    ...
    public void init() {
        ...
        autonTaskExecuter.tasks.add(new AutonPointTask(-75100, -18100, (float)Math.toRadians(0), 0, 0));
        autonTaskExecuter.tasks.add(new AutonPointTask(-65100, -18100, (float)Math.toRadians(-90), 0, 0));
        autonTaskExecuter.tasks.add(new AutonPointTask(57000, -18100, (float)Math.toRadians(-90), 0, 0));
