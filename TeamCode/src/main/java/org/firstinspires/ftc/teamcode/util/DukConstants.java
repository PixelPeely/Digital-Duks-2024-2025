...
public class DukConstants {
    public static final class INPUT {
        ...
        public static final double MANUAL_LIFT_SPEED = 100f;
    }
    ...
    public static final class HARDWARE {
        public static final double ET_PER_MM = 2000 / (35 * Math.PI);
        ...
        public static final int MIN_LIFT_HEIGHT = 400;
    ...
    public static final class AUTOMATED_CONTROLLER_PARAMS {
        ...
        public static final PIDFCalculator ROBOT_PURSUIT_PID = new PIDFCalculator(0.00000005, 0, 0, 0, 0, 0, 0, false);
        ...
        public static final double STANDARD_HEADING_RANGE = 0.035f;
