...
public class RedLeftSpike extends OpMode {
    ...
    public void init() {
        ...
        autonTaskExecuter.tasks.add(new AutonPointTask(-75100, -15000, (float)Math.toRadians(0), 0, 0));
        autonTaskExecuter.tasks.add(new AutonPointTask(-65100, -15000, (float)Math.toRadians(-90), 0, 0));
        autonTaskExecuter.tasks.add(new AutonPointTask(57000, -15000, (float)Math.toRadians(-90), 0, 0));
